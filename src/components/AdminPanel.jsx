            ...
            <form onSubmit={handleSaveSettings}>
              ...
              <div className="form-group">
                <label className="form-label" style={{ display: 'flex', alignItems: 'center', gap: '0.45rem' }}>
                  ...
                  Store Facebook Page URL (For Follow Buttons)
                </label>
                <input
                  type="url"
                  placeholder="https://www.facebook.com/falgunisdesign"
                  value={settings.facebookUrl || ''}
                  onChange={e => setSettings({ ...settings, facebookUrl: e.target.value })}
                  className="form-input"
                />
                <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                  Visitors clicking "Follow on Facebook" in the header, footer, or floating badge will open this page to follow you.
                </span>
              </div>
